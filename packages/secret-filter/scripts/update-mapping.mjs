...
function renderModule(mappingData) {
  const mappingLiteral = JSON.stringify(mappingData, null, 2);

  return `// AUTO-GENERATED FILE. DO NOT EDIT.\n//\n// Generated by: packages/secret-filter/scripts/update-mapping.mjs\n\nimport type { SecretMappingData } from "../types.ts";\n\nexport const SECRET_MAPPING_DATA: SecretMappingData = ${mappingLiteral};\n`;
}
...
async function main() {
  ...
  const mappingData = JSON.parse(rawJson);
  const content = renderModule(mappingData);
